...
- **Repository Features** – Full list of built-in CI/CD, security, and DX features at [.github/docs/repository-features.md](.github/docs/repository-features.md)
- **GitHub Workflows** – Workflow descriptions and the control center at [.github/docs/workflows.md](.github/docs/workflows.md)
