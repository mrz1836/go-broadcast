...
#### Flat Style (Default)
```html
<img src="https://mrz1836.github.io/go-broadcast/badges/main.svg" alt="Coverage" />
```
...
```markdown
<!-- Main branch -->
![Main Coverage](https://mrz1836.github.io/go-broadcast/badges/main.svg)

<!-- Develop branch -->
![Develop Coverage](https://mrz1836.github.io/go-broadcast/badges/develop.svg)

<!-- Feature branch -->
![Feature Coverage](https://mrz1836.github.io/go-broadcast/badges/feature-new-api.svg)
```
...
```markdown
<!-- PR #123 -->
![PR Coverage](https://mrz1836.github.io/go-broadcast/badges/pr/123.svg)
```
...
---
*Generated by [GoFortress Coverage](https://mrz1836.github.io/go-broadcast) 🤖*
```
...
```markdown
📊 **Coverage: 87.2%** (+2.1%) | [View Report](https://mrz1836.github.io/go-broadcast/reports/pr/123)
```
