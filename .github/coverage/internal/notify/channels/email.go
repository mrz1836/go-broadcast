...
func NewEmailChannel(config *notify.EmailConfig) *EmailChannel {
	var auth smtp.Auth
...
func (e *EmailChannel) Send(ctx context.Context, notification *notify.Notification) (*notify.DeliveryResult, error) {
	startTime := time.Now()
...
func (e *EmailChannel) ValidateConfig() error {
	...
	if !isValidEmail(e.config.FromAddress) {
		return fmt.Errorf("invalid from address: %s", e.config.FromAddress)
	}
...
func (e *EmailChannel) GetChannelType() notify.ChannelType {
...
func (e *EmailChannel) SupportsRichContent() bool {
	return e.config.UseHTML
}

// GetRateLimit returns the rate limit configuration
func (e *EmailChannel) GetRateLimit() *notify.RateLimit {
	return e.rateLimit
}

// buildEmailMessage builds an email message from a notification
func (e *EmailChannel) buildEmailMessage(notification *notify.Notification) (string, error) {
	// Prepare email data
	emailData := &EmailData{
	...
	if e.config.UseHTML && e.templates.HTML != nil {
...
func (e *EmailChannel) buildSimpleHTML(emailData *EmailData) string {
	...
	body.WriteString(fmt.Sprintf("<div class=\"header\">\n"))
...
func (e *EmailChannel) getSeverityPrefix(severity notify.SeverityLevel) string {
	switch severity {
...
func (e *EmailChannel) getPriorityLevel(priority notify.Priority) string {
	switch priority {
