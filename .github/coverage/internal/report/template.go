...
<body>
    ...
    <div class="container">
        <!-- Header -->
        <header class="header">
            <a href="https://{{.RepositoryOwner}}.github.io/{{.RepositoryName}}/" class="header-link">
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-item">
                ...
                <span class="footer-version">{{.LatestTag}}</span>
            </div>
            ...
            <div class="footer-item">
                <span class="footer-icon">🕐</span>
                <span class="footer-time">{{.Generated.Format "2006-01-02 15:04:05 UTC"}}</span>
            </div>
        </div>
    </footer>
